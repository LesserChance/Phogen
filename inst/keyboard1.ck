class Keyboard1 extends PhogenInstrument {
    ...
    JCRev r;
    Echo e;
    e.delay(Global.pho.tg.beat * beat_speed / 2);
...
//        e => ins_gain => ugen;
    ...
    public void handlePhraseStart(int phoneme_index) {
        ...
        beat_speed_weights_total[note_weight_choice][phoneme_index] => divide_beat_speed;
    }
...
//            if (set_decay_rate < max_decay_rate) {
//                100 +=> set_decay_rate;
//            }
//        }
//        if (phoneme_index % 4 == 0) {
//            if (set_decay_rate > min_decay_rate) {
//                100 -=> set_decay_rate;
//            }
//        }
    }
    ...
    public void playCommand(int command[]) {
        if (command.size() > 0) {
            ...
            command[5] => int set_divide_beat_speed;
